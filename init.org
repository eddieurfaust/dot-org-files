...
** avy, a better =ace-jump=
   ...
   #+END_QUOTE
   - =avy-keys= erwartet offenbar eine Liste mit allen Buchstaben [a-z]. Der "Code point" wird offenbar mit dem <?> Operator zurück gegeben.
...
(use-package gnuplot
  ...
  (setq auto-mode-alist (append '(("\\.png$" . auto-revert-mode)) auto-mode-alist))
  (setq revert-without-query '(".*.png"))
  (setq auto-image-file-mode '(".*.png"))
)
#+END_SRC
